...
impl Camera {
    ...
    pub fn update_position(&mut self, process: &Process, speed_x: f32, speed_y: f32) {
        self.f_cam_x = process.read_value(self.data_base_addr + 0x200);
        self.f_cam_y = process.read_value(self.data_base_addr + 0x204);
        self.f_cam_z = process.read_value(self.data_base_addr + 0x208);

        self.p_cam_x = process.read_value(self.data_base_addr + 0x220);
        self.p_cam_y = process.read_value(self.data_base_addr + 0x224);
        self.p_cam_z = process.read_value(self.data_base_addr + 0x228);

        self.fov = process.read_value(self.data_base_addr + 0x260);
        ...
        self.p_cam_y = self.p_cam_y + dp_forward*r_cam_y;
        ...
        // process.write_value::<f32>(p_shellcode + 0x240, 0.);
        // process.write_value::<f32>(p_shellcode + 0x244, 1.);
        // process.write_value::<f32>(p_shellcode + 0x248, 0.);
    }
